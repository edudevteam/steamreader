...
export default function SearchPage() {
  ...
  // Filtering stays client-side against the cached index: it keeps results
  // instant as you type, which a per-keystroke query could not.
          ...
          <form onSubmit={handleSearch} className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full rounded-full border border-gray-300 bg-white px-5 py-3 pl-12 text-gray-900 placeholder:text-gray-500 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500"
              />
              <svg
