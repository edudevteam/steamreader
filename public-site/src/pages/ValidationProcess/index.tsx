  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mb-8 text-lg text-gray-600">
        We use a validation system to help readers identify trustworthy and
        verified content. Each badge represents a different level of
        verification that an article has undergone.
      </p>
      ...
      <div className="space-y-8">
        ...
        <div className="rounded-lg border border-gray-200 p-6">
          ...
          <p className="mb-4 text-gray-600">
            A community member has read this article. This helps track
            engagement and indicates that the content has been reviewed by the
            community.
          </p>
          ...
          <ul className="list-inside list-disc space-y-1 text-gray-600">
            ...
            <li>
              Reading is automatically recorded when you verify or endorse an
              article
            </li>
        ...
        <div className="rounded-lg border border-gray-200 p-6">
          ...
          <p className="mb-4 text-gray-600">
            A community member has successfully completed this tutorial from
            start to finish, verifying that all steps work as described and
        ...
        <div className="rounded-lg border border-gray-200 p-6">
          ...
          <p className="mb-4 text-gray-600">
            A community member has verified that all external links and embedded
            videos in this article are working and accessible.
          </p>
          <h3 className="mb-2 font-semibold text-gray-900">
        ...
        <div className="rounded-lg border border-gray-200 p-6">
          ...
          <p className="mb-4 text-gray-600">
            A community member personally recommends this content as valuable,
            accurate, and helpful. Endorsements indicate strong approval from
            the community.
          </p>
          <h3 className="mb-2 font-semibold text-gray-900">
          ...
          <ul className="list-inside list-disc space-y-1 text-gray-600">
            <li>
              Registered community members can endorse articles they find
              valuable
            </li>
      ...
      <div className="mt-12 rounded-lg bg-gray-50 p-6">
        ...
        <p className="text-gray-600">
          If you have questions about our validation process or would like to
          become a reviewer, please visit our{' '}
          <Link
            to="/support"
