  ...
  const socialLinks = [
    {
      ...
      href: 'https://reddit.com/r/steamreader',
      icon: (
    ...
    },
    {
      ...
      href: 'https://discord.gg/steamreader',
      icon: (
        <svg className="size-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: 'https://twitter.com/steamreader',
      icon: (
        <svg className="size-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      href: 'https://github.com/steamreader',
      icon: (
        <svg className="size-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mb-8 text-lg text-gray-600">
        Have questions, feedback, or just want to connect? Find us on these
        platforms.
      </p>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {socialLinks.map((link) => (
          ...
          >
            ...
            <div>
              <h2 className="font-semibold text-gray-900">{link.name}</h2>
      ...
      <div>
        ...
        <div className="mt-6 rounded-lg bg-brand-50 p-8">
          ...
          <p className="mt-3 text-gray-600">
            ...
            . All new accounts are automatically subscribed to the newsletter —
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-yellow-700">
                  Your first newsletter email may land in your spam or junk
                  folder. If you don't see it in your inbox, be sure to check
                  there and mark it as "not spam" so future emails arrive in
                  your inbox.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Every newsletter email includes an unsubscribe link at the
                  bottom. If you'd like to stop receiving the newsletter, simply
          ...
          <div className="rounded-lg border border-gray-200 bg-gray-50 p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Changed your mind? If you've previously unsubscribed and would
                  like to start receiving the newsletter again, reach out to us
