  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg">
        ...
        <p>
          By accessing and using STEAM Reader, you accept and agree to be bound
        ...
        <p>
          You must be at least 13 years old to create an account and use our
          services. By creating an account, you confirm that you meet this age
          requirement.
        </p>
        ...
        <p>
          You agree to use STEAM Reader only for lawful purposes. You may not
          use our services to:
        </p>
        <ul>
        ...
        <h2>5. Content</h2>
        <p>
          All content provided on STEAM Reader is for educational purposes.
          While we strive to ensure accuracy, we make no warranties about the
        ...
        <h2>7. Privacy</h2>
        <p>
          Your use of STEAM Reader is also governed by our Privacy Policy. By
        ...
        <p>
          We may update these terms from time to time. Continued use of STEAM
          Reader after any changes constitutes acceptance of the new terms.
        </p>
