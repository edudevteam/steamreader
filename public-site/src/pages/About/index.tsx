  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-lg">
        ...
        <ul>
          <li>
            <strong>Reader</strong> — what every new account starts as. You can
            read every published article and vote on them. No writing.
          </li>
          <li>
            <strong>Writer</strong> — can draft and edit their own articles and
            submit them for review. Writers cannot publish; an editor has to
            approve the work first.
          </li>
          <li>
            <strong>Editor</strong> — reviews, edits and publishes any article,
            and manages categories and tags.
          </li>
          <li>
            <strong>Admin</strong> — everything an editor can do, plus managing
            accounts.
          </li>
        </ul>
        <p>
          So creating an account does not by itself let you post — you'll be a
          Reader until an admin promotes you to Writer. If you'd like to
          contribute, <Link to="/signup">create an account</Link> first, then{' '}
